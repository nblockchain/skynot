...
exec sudo -i -u pi bash -c 'export npm_config_prefix=$HOME/.npm-global && export WORK_DIR=$HOME/Documents/Coding && mkdir -p $WORK_DIR && cd $WORK_DIR && ${installDir}/node_modules/.bin/pi "$@"' -- "$@"
`;
